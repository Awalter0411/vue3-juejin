<template>
  <div class="flex relative">
    <input
      class="border-2 border-grey-200 w-48 h-9 -mt-2 outline-none text-slate-400 text-sm pl-2 focus:border-blue-500 rounded"
    />
    <button class="-mt-2 bg-gray-100 h-8 rounded absolute right-0.5 top-0.5">
      <svg
        t="1666079902834"
        class="icon"
